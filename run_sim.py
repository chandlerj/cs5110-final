...
f1 = make_basicfarm(
    "montpellier_clay_bean", field0, [(Weather, "montpellier"), (Soil, "clay"), (Plant, "bean")]
)
f2 = make_basicfarm(
    "montpellier_sand_bean",
    field0,
    [(Weather, "montpellier"), (Soil, "sand"), (Plant, "bean")],
)
f3 = make_basicfarm(
    "montpellier_clay_corn",
    field0,
    [(Weather, "montpellier"), (Soil, "clay"), (Plant, "corn")],
)
f4 = make_basicfarm(
    "montpellier_sand_corn",
    field0,
    [(Weather, "montpellier"), (Soil, "sand"), (Plant, "corn")],
)
f5 = make_basicfarm(
    "montpellier_clay_tomato",
    field0,
    [(Weather, "montpellier"), (Soil, "clay"), (Plant, "tomato")],
)
f6 = make_basicfarm(
    "montpellier_sand_tomato",
    field0,
    [(Weather, "montpellier"), (Soil, "sand"), (Plant, "tomato")],
)
f7 = make_basicfarm(
    "montpellier_clay_bean_pollinator",
    field0,
    [(Weather, "montpellier"), (Soil, "clay"), (Plant, "bean"), (Pollinators, "bee")],
)
f8 = make_basicfarm(
    "montpellier_clay_corn_pollinator",
    field0,
    [(Weather, "montpellier"), (Soil, "clay"), (Plant, "corn"), (Pollinators, "bee")],
)
f9 = make_basicfarm(
    "montpellier_clay_tomato_pollinator",
    field0,
    [(Weather, "montpellier"), (Soil, "clay"), (Plant, "tomato"), (Pollinators, "bee")],
)
